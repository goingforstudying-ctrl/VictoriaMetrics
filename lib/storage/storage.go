...
func (s *Storage) SearchTSIDs(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) ([]TSID, error) {
...
func (s *Storage) SearchMetricNames(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) ([]string, error) {
...
// from them.
func (s *Storage) DeleteSeries(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, maxMetrics int) (int, error) {
...
func (s *Storage) SearchLabelNames(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tfss []*TagFilters, tr TimeRange, maxLabelNames, maxMetrics int) ([]string, error) {
...
func (s *Storage) SearchLabelValues(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, labelName string, tfss []*TagFilters, tr TimeRange, maxLabelValues, maxMetrics int) ([]string, error) {
...
func (s *Storage) SearchTagValueSuffixes(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tr TimeRange, tagKey, tagValuePrefix string, delimiter byte, maxTagValueSuffixes int) ([]string, error) {
	search := func(qt *querytracer.Tracer, idb *indexDB, tr TimeRange) (map[string]struct{}, error) {
...
func (s *Storage) SearchGraphitePaths(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tr TimeRange, query []byte, maxPaths int) ([]string, error) {
...
func (s *Storage) GetSeriesCount(ctx *RequestContext, accountID, projectID uint32) (uint64, error) {
	tr := TimeRange{
		MinTimestamp: 0,
...
func (s *Storage) SearchTenants(ctx *RequestContext, qt *querytracer.Tracer, tr TimeRange) ([]string, error) {
...
func (s *Storage) GetTSDBStatus(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tfss []*TagFilters, date uint64, focusLabel string, topN, maxMetrics int) (*TSDBStatus, error) {
...
func (s *Storage) GetMetricNamesStats(_ *RequestContext, _ *querytracer.Tracer, tt *TenantToken, limit, le int, matchPattern string) metricnamestats.StatsResult {
	if tt != nil {
...
func (s *Storage) GetMetadataRows(_ *RequestContext, qt *querytracer.Tracer, tt *TenantToken, limit int, metricName string) ([]*metricsmetadata.Row, error) {
	var (

...
// the given tr.
func (db *indexDB) SearchLabelNames(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tfss []*TagFilters, tr TimeRange, maxLabelNames, maxMetrics int) (map[string]struct{}, error) {
...
func (is *indexSearch) searchLabelNamesWithFiltersOnTimeRange(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxLabelNames, maxMetrics int) (map[string]struct{}, error) {
...
func (is *indexSearch) searchLabelNamesWithFiltersOnDate(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, date uint64, maxLabelNames, maxMetrics int) (map[string]struct{}, error) {
...
func (db *indexDB) SearchTenants(ctx *RequestContext, qt *querytracer.Tracer, tr TimeRange) (map[string]struct{}, error) {
...
func (is *indexSearch) searchTenantsOnTimeRange(ctx *RequestContext, qt *querytracer.Tracer, tr TimeRange) (map[string]struct{}, error) {
...
func (is *indexSearch) searchTenantsOnDate(ctx *RequestContext, date uint64) (map[string]struct{}, error) {
...
func (db *indexDB) SearchLabelValues(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, labelName string, tfss []*TagFilters, tr TimeRange, maxLabelValues, maxMetrics int) (map[string]struct{}, error) {
...
func (is *indexSearch) searchLabelValuesOnTimeRange(ctx *RequestContext, qt *querytracer.Tracer, labelName string, tfss []*TagFilters, tr TimeRange, maxLabelValues, maxMetrics int) (map[string]struct{}, error) {
	if tr == globalIndexTimeRange {
...
func (is *indexSearch) searchLabelValuesOnDate(ctx *RequestContext, qt *querytracer.Tracer, labelName string, tfss []*TagFilters, date uint64, maxLabelValues, maxMetrics int) (map[string]struct{}, error) {
...
func (db *indexDB) SearchTagValueSuffixes(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tr TimeRange, tagKey, tagValuePrefix string, delimiter byte, maxTagValueSuffixes int) (map[string]struct{}, error) {
...
func (is *indexSearch) searchTagValueSuffixesForTimeRange(ctx *RequestContext, tr TimeRange, tagKey, tagValuePrefix string, delimiter byte, maxTagValueSuffixes int) (map[string]struct{}, error) {
	if tr == globalIndexTimeRange {
...
func (is *indexSearch) searchTagValueSuffixesAll(ctx *RequestContext, tagKey, tagValuePrefix string, delimiter byte, maxTagValueSuffixes int) (map[string]struct{}, error) {
	kb := &is.kb
...
func (is *indexSearch) searchTagValueSuffixesForDate(ctx *RequestContext, date uint64, tagKey, tagValuePrefix string, delimiter byte, maxTagValueSuffixes int) (map[string]struct{}, error) {
...
func (is *indexSearch) searchTagValueSuffixesForPrefix(ctx *RequestContext, nsPrefix byte, prefix []byte, tagValuePrefixLen int, delimiter byte, maxTagValueSuffixes int) (map[string]struct{}, error) {
	kb := &is.kb
	ts := &is.ts
	mp := &is.mp
	dmis := is.db.getDeletedMetricIDs()
...
func (db *indexDB) SearchGraphitePaths(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tr TimeRange, qHead, qTail []byte, maxPaths int) (map[string]struct{}, error) {
...
func (db *indexDB) GetSeriesCount(ctx *RequestContext, accountID, projectID uint32) (uint64, error) {
	is := db.getIndexSearch(accountID, projectID)
...
func (is *indexSearch) getSeriesCount(ctx *RequestContext) (uint64, error) {
	ts := &is.ts
	kb := &is.kb
	loopsPaceLimiter := 0
...
func (db *indexDB) GetTSDBStatus(ctx *RequestContext, qt *querytracer.Tracer, accountID, projectID uint32, tfss []*TagFilters, date uint64, focusLabel string, topN, maxMetrics int) (*TSDBStatus, error) {
...
// getTSDBStatus returns topN entries for tsdb status for the given tfss, date and focusLabel.
func (is *indexSearch) getTSDBStatus(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, date uint64, focusLabel string, topN, maxMetrics int) (*TSDBStatus, error) {
	filter, err := is.searchMetricIDsWithFiltersOnDate(ctx, qt, tfss, date, maxMetrics)
	if err != nil {
		return nil, err
	}
...
func (db *indexDB) DeleteSeries(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, maxMetrics int) (*uint64set.Set, error) {
...
func (db *indexDB) searchMetricIDs(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) (*uint64set.Set, error) {
...
func (db *indexDB) SearchTSIDs(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) ([]TSID, error) {
...
func (db *indexDB) SearchMetricNames(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) ([]string, error) {
...
func (is *indexSearch) updateMetricIDsByMetricNameMatch(ctx *RequestContext, qt *querytracer.Tracer, metricIDs, srcMetricIDs *uint64set.Set, tfs []*tagFilter) error {
...
func (is *indexSearch) searchMetricIDsWithFiltersOnDate(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, date uint64, maxMetrics int) (*uint64set.Set, error) {
	if len(tfss) == 0 {
		return nil, nil
	}
...
func (is *indexSearch) searchMetricIDs(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) (*uint64set.Set, error) {
	metricIDs, err := is.searchMetricIDsInternal(ctx, qt, tfss, tr, maxMetrics)
	if err != nil {
		return nil, err
	}
...
func (is *indexSearch) searchMetricIDsInternal(ctx *RequestContext, qt *querytracer.Tracer, tfss []*TagFilters, tr TimeRange, maxMetrics int) (*uint64set.Set, error) {
...
func (is *indexSearch) updateMetricIDsForTagFilters(ctx *RequestContext, qt *querytracer.Tracer, metricIDs *uint64set.Set, tfs *TagFilters, tr TimeRange, maxMetrics int) error {
	if tr != globalIndexTimeRange {
...
func (is *indexSearch) getMetricIDsForTagFilter(ctx *RequestContext, qt *querytracer.Tracer, tf *tagFilter, maxMetrics int, maxLoopsCount int64) (*uint64set.Set, int64, error) {
	if tf.isNegative {
...
func (is *indexSearch) getMetricIDsForTagFilterSlow(ctx *RequestContext, tf *tagFilter, f func(metricID uint64), maxLoopsCount int64) (int64, error) {
	if len(tf.orSuffixes) > 0 {
...
func (is *indexSearch) updateMetricIDsForOrSuffixes(ctx *RequestContext, tf *tagFilter, metricIDs *uint64set.Set, maxMetrics int, maxLoopsCount int64) (int64, error) {
	if tf.isNegative {
		logger.Panicf("BUG: isNegative must be false")
	}
	kb := kbPool.Get()
...
func (is *indexSearch) updateMetricIDsForOrSuffix(ctx *RequestContext, prefix []byte, metricIDs *uint64set.Set, maxMetrics int, maxLoopsCount int64) (int64, error) {
	ts := &is.ts
	mp := &is.mp
	var loopsCount int64
	loopsPaceLimiter := 0
...
func (is *indexSearch) updateMetricIDsForDateRange(ctx *RequestContext, qt *querytracer.Tracer, metricIDs *uint64set.Set, tfs *TagFilters, minDate, maxDate uint64, maxMetrics int) error {
	if minDate == maxDate {
...
func (is *indexSearch) getMetricIDsForDateAndFilters(ctx *RequestContext, qt *querytracer.Tracer, date uint64, tfs *TagFilters, maxMetrics int) (*uint64set.Set, error) {
	if qt.Enabled() {
...
func (is *indexSearch) getMetricIDsForDateTagFilter(ctx *RequestContext, qt *querytracer.Tracer, tf *tagFilter, date uint64, commonPrefix []byte,
...
func (is *indexSearch) getMetricIDsForDate(ctx *RequestContext, date uint64, maxMetrics int) (*uint64set.Set, error) {
...
func (is *indexSearch) updateMetricIDsForPrefix(ctx *RequestContext, prefix []byte, metricIDs *uint64set.Set, maxMetrics int) error {
	ts := &is.ts
	mp := &is.mp
	loopsPaceLimiter := 0
	ts.Seek(prefix)

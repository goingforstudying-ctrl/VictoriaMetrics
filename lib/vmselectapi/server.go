...
func newRequestContextForConn(bc *handshake.BufferedConn, deadline uint64) (*storage.RequestContext, *connMonitor) {
	sCtx, cancel := context.WithCancel(context.Background())
	rCtx := storage.NewRequestContext(sCtx, deadline)
